            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link <?php if ($keluar == "keluar") echo "active"; ?>" href="keluar.php">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <?php if (!$success) echo 'd-none';
                                ...
                                <?php
                                if ($success && $_GET['added'] === 'true') echo 'Data Obat Keluar Berhasil Disimpan!';
                                else if ($success && $_GET['added'] === 'false') echo 'Nama Obat Keluar Sudah Ada!';
                                ?>
                            ...
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    <?php
                                    $ambilsemuadatastock = mysqli_query($conn, "select * from keluar k, stock s where s.idobat = k.idobat");
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post">
                                                        <div class="modal-body">
                                                            ...
                                                            <button type="submit" class="btn btn-primary" name="updateobatkeluar">Submit</button>
                                                        </div>
                                                    </form>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post">
                                                        <div class="modal-body">
                                                            ...
                                                            <br>
                                                            <br>
                                                            <button type="submit" class="btn btn-danger" name="hapusobatkeluar">Submit</button>
                                                        </div>
                                                    </form>
        ...
        <div class="modal-content">
            ...
            <form method="post">
                <div class="modal-body">
                    ...
                    <br>
                    <button type="submit" class="btn btn-primary" name="addobatkeluar">Submit</button>
                </div>
            </form>
        </div>
    </div>
